...
func NewOAuth2Manager(redisClient *redis.Client) *OAuth2Manager {
...
func (p *BaseOAuth2Provider) AuthURL(state string) string {
	params := url.Values{
...
func (p *BaseOAuth2Provider) Exchange(ctx context.Context, code string) (*OAuth2Token, error) {
	data := url.Values{
		"client_id":     {p.Config.ClientID},
