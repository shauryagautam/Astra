...
func LoadFromEnv(c *Config) *AstraConfig {
	return &AstraConfig{
		App: AppConfig{
			...
			TrustedProxies:  strings.Split(c.String("TRUSTED_PROXIES", ""), ","),
		},
		Database: DatabaseConfig{
			Connection:      c.String("DB_CONNECTION", "postgres"),
			...
			NeonAPIKey:      c.String("NEON_API_KEY", ""),
			NeonProjectID:   c.String("NEON_PROJECT_ID", ""),
		},
		Redis: RedisConfig{
		...
		Telemetry: TelemetryConfig{
			...
			MaxEntries:  c.Int("TELEMETRY_MAX_ENTRIES", 100),
		},
		WS: WSConfig{
		...
		OAuth2: OAuth2Config{
			Google: OAuth2ProviderEnvConfig{
				ClientID:     c.String("GOOGLE_CLIENT_ID", ""),
				ClientSecret: c.String("GOOGLE_CLIENT_SECRET", ""),
				RedirectURL:  c.String("GOOGLE_REDIRECT_URL", ""),
			},
			GitHub: OAuth2ProviderEnvConfig{
				ClientID:     c.String("GITHUB_CLIENT_ID", ""),
				ClientSecret: c.String("GITHUB_CLIENT_SECRET", ""),
				RedirectURL:  c.String("GITHUB_REDIRECT_URL", ""),
			},
			Discord: OAuth2ProviderEnvConfig{
				ClientID:     c.String("DISCORD_CLIENT_ID", ""),
				ClientSecret: c.String("DISCORD_CLIENT_SECRET", ""),
				RedirectURL:  c.String("DISCORD_REDIRECT_URL", ""),
			},
			Apple: OAuth2ProviderEnvConfig{
				ClientID:     c.String("APPLE_CLIENT_ID", ""),
				ClientSecret: c.String("APPLE_CLIENT_SECRET", ""),
				RedirectURL:  c.String("APPLE_REDIRECT_URL", ""),
			},
			Microsoft: OAuth2ProviderEnvConfig{
				ClientID:     c.String("MICROSOFT_CLIENT_ID", ""),
				ClientSecret: c.String("MICROSOFT_CLIENT_SECRET", ""),
				RedirectURL:  c.String("MICROSOFT_REDIRECT_URL", ""),
			},
		},
	}
}
