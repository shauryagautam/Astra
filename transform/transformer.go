...
func Paginated[T any](p orm.Paginated[T], t Transformer[T]) map[string]any {
...
func CursorPaginated[T any](p orm.CursorPaginated[T], t Transformer[T]) map[string]any {
	return map[string]any{
		"data":        Collection(p.Data, t),
